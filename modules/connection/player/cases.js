    ...
    case() {
        switch (this.len) {
            ...
            case protocol.client.playerUpdate:
                ...
                if (NONEmodToolsIDs[tool] && this.client.rank >= permissions.mod) {
                    this.client.tool = tool;
                    tool = tool;
                } else if (NONEmodToolsIDs[tool] && this.client.rank < permissions.mod) {
                    this.client.tool = 0;
                    tool = 0;
                } else if (!NONEmodToolsIDs && this.client.rank < permissions.mod) {
                    this.client.tool = tool;
                    tool = tool;
                };
